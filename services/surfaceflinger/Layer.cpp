...
void Layer::setPerFrameData(const sp<const DisplayDevice>& hw,
    ...
    if (mSurfaceFlingerConsumer->getAlreadyStereo())
        setAlreadyStereo(layer,mSurfaceFlingerConsumer->getAlreadyStereo());
    else if (isFullScreen(hw,layer))
