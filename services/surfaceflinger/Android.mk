...
LOCAL_CFLAGS += -DROCKCHIP_VIRTUAL_REALITY
endif
...
ifeq ($(strip $(TARGET_BOARD_PLATFORM)),rk3288)
	LOCAL_CFLAGS += -DUSE_LCDC_COMPOSER -DFORCE_SCALE_FULLSCREEN -DSF_RK3288
endif
ifeq ($(strip $(TARGET_BOARD_PLATFORM)),rk3368)
	LOCAL_CFLAGS += -DUSE_LCDC_COMPOSER -DFORCE_SCALE_FULLSCREEN -DSF_RK3368
endif
ifeq ($(strip $(TARGET_BOARD_PLATFORM)),rk3366)
	LOCAL_CFLAGS += -DUSE_LCDC_COMPOSER -DFORCE_SCALE_FULLSCREEN -DSF_RK3366
endif
ifeq ($(strip $(TARGET_BOARD_PLATFORM)),rk3399)
        LOCAL_CFLAGS += -DUSE_LCDC_COMPOSER -DFORCE_SCALE_FULLSCREEN -DSF_RK3399
endif
ifeq ($(strip $(TARGET_BOARD_PLATFORM)),rk322x)
        LOCAL_CFLAGS += -DFORCE_SCALE_FULLSCREEN -DSF_RK322X
endif
